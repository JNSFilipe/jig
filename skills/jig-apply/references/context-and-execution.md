...
Use jig-apply's situation/action table for routine context decisions. Read this reference when carrying out a handoff/reset or responding to a requested transition; reuse it once loaded.
...
<jig-apply SKILL.md>. You are the implementation worker.
