...
Return findings to the enclosing workflow or assigned parent. An authorized implementation can continue through apply when installed; otherwise report the correction, evidence, and remaining work. Diagnosis alone does not authorize closeout or publication.
